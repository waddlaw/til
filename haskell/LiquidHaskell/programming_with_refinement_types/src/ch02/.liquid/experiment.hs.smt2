...
(declare-fun lq_anf$36$$35$$35$7205759403792795623$35$$35$dwD () Int)
...
(declare-fun lq_anf$36$$35$$35$7205759403792795621$35$$35$dwB () Int)
...
(assert (= (strLen lit$36$main) 4))
(push 1)
(assert (and (not GHC.Types.False) GHC.Types.True (not GHC.Types.False) GHC.Types.True (and (not VV$35$$35$F$35$$35$2) (= VV$35$$35$F$35$$35$2 GHC.Types.False)) (and (=> (=> false true) false) (=> false (=> true false)) (= true true) (=> true true) (=> true true) Main.t)))
(push 1)
(assert (not (and (=> (=> false true) false) (=> false (=> true false)) (= true true) (=> true true) (=> true true) (not VV$35$$35$F$35$$35$2))))
(check-sat)
; SMT Says: Unsat
(pop 1)
(pop 1)
(push 1)
(assert (and (not GHC.Types.False) GHC.Types.True (not GHC.Types.False) GHC.Types.True (and VV$35$$35$F$35$$35$3 (= VV$35$$35$F$35$$35$3 GHC.Types.True))))
(push 1)
(assert (not (and (=> (=> false true) false) (=> false (=> true false)) (= true true) (=> true true) (=> true true) VV$35$$35$F$35$$35$3)))
(check-sat)
; SMT Says: Sat
(pop 1)
(pop 1)
